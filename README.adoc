...
Deploy and configure a TSSC pipeline for the http://gitea.apps.tssc.rht-set.com/tssc-references/reference-quarkus-mvn-jenkins[TSSC Quark reference app]; this includes importing and updating the config of the git repos.
